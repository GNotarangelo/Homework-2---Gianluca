...
def generate_launch_description():
    ...
    # Definiamo la path verso i modelli
    iiwa_description_dir = get_package_share_directory('iiwa_description')
    models_path = os.path.join(iiwa_description_dir, 'gazebo', 'models')
    
    # Aggiungiamola all'EV così che la tag URI se la vada a cercare
    set_model_path = SetEnvironmentVariable(
        name='GZ_SIM_RESOURCE_PATH',
        # La nuova path è aggiunta a quelle già presenti
